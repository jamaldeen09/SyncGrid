...
const ProfilePage = (): React.ReactElement => {
    ...
    useEffect(() => {
        ...
        console.log("USE EFFECT RESPONSIBLE FOR FETCHING GAME HAS BEEN TRIGGERED!")
                        ...
                        <div className="flex items-center justify-between border-b border-zinc-100 pb-4">
                            <div className="space-y-1">
                                ...
                                <p className="text-[10px] text-zinc-400 font-bold tracking-widest uppercase">
                                    Total Sessions: {profile?.totalGamesPlayed || 0}
                                </p>
                            </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 gap-2">
                                <div className="p-4 bg-white border border-zinc-200">
                                    ...
                                    <p className="text-3xl font-black italic tracking-tighter text-emerald-600">64.2%</p>
                                </div>
                                <div className="p-4 bg-white border border-zinc-200">
