        ...
        <>
            ...
            <nav className="w-full h-20 px-4 sm:px-8 flex shrink-0 justify-between items-center border-b border-zinc-200 bg-white z-50">
                ...
                <div className="flex items-center gap-3 sm:gap-6">
                    <div className="h-5 w-5 sm:h-6 sm:w-6 bg-emerald-500 rounded-sm shrink-0" />
                    <h1 className="text-xs sm:text-sm font-bold tracking-[0.2em] uppercase truncate">SyncGrid</h1>
                </div>
